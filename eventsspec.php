...
// Count total organizer-specific events
$count_query = "
...
// Organizer-specific events query with pagination
$query = "
SELECT 
    e.EventID,
    e.EventName,
...
// Venue dropdown remains the same
...
<!-- Pop-up if insert is successful -->
 <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.5" min="0" name="e_cost" class="form-control" required>
                    </div>
                    ...
                    <!-- user option to add new venue -->
                     <div class="form-group" id="newVenueField" style="display: none;">
                        ...
                        <input type="text" name="new_event_venue" class="form-control" placeholder="Enter name of new venue">
                    </div>
